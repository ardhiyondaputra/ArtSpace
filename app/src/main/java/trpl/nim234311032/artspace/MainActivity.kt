package trpl.nim234311032.artspace
...
import trpl.nim234311032.artspace.ui.theme.ArtSpaceTheme
...
fun ArtScapeApp(modifier: Modifier = Modifier) {
    ...
    val titles = listOf("The light and the sea", "The a lot of mountains", "The mountains and flowers")
    val artists = listOf("Pablo Picasso (1865)", "Gustav Klimt (1764)", "Vincent Van (1893)")
